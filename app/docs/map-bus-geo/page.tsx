...
const LiveBusRoutePreview = async ({ routeId }: { routeId: string }) => {
  const data = await getCachedBusRouteGeometry(routeId, PREVIEW_BUS_DIRECTION)
      ...
      <article className="space-y-14">
        ...
        <section className="space-y-3" aria-labelledby="getting-data-heading">
          ...
          <p className="max-w-prose text-muted-foreground">
            Pass a normalised <code className="text-xs">BusRouteGeometry</code>.
            Live sequences come from{" "}
