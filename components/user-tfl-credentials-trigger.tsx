 ...
 * Dialog mounts here once (no header affordance).
 */
  ...
  return (
    <>
      <button
        ...
        onClick={openDialog}
        className={cn(
          "inline-flex min-h-9 w-full items-center gap-1.5 rounded-md px-2 py-1.5 text-xs text-sidebar-foreground/70 hover:bg-sidebar-accent hover:text-sidebar-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sidebar-ring",
          className,
        )}
        aria-label={
          ready
