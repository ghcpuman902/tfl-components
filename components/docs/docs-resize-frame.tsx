    ...
    <div className="space-y-2">
      <div className="relative w-fit max-w-full">
        ...
        <button
          ...
          className={cn(
            "absolute top-1/2 right-0 z-10 flex h-11 w-7 translate-x-1/2 -translate-y-1/2 touch-none items-center justify-center rounded-md border border-border bg-background shadow-sm",
            "md:hidden"
          )}
