...
} from "@/components/tfl/diagram/horizontal-line-diagram";
    ...
    <div className="grid gap-8 lg:grid-cols-2">
      <section className="rounded-lg border border-border bg-card p-4 sm:p-6">
        ...
        <p className="mt-3 text-xs text-muted-foreground">
          ...
          <Link href="/tools/route-stations?lineId=central&direction=outbound" className="underline">
            raw sequence
          </Link>
        </p>
      </section>
...
export default function LineDiagramDemo() {
