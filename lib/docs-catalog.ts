...
export const DOCS_ENTRIES: readonly DocsEntry[] = [
  ...
  // —— Hidden from docs sidebar (search / redirects / Blocks / Tools / Explorer children) ——
  {
    ...
    group: "explore",
    kind: "page",
    href: "/docs/explorer?kind=lines&domain=tube-rail&tab=browse",
  ...
  },
  {
    ...
    group: "explore",
    kind: "page",
    href: "/docs/explorer?kind=lines&domain=tube-rail&tab=browse&id=central",
    sidebarSection: "hidden",
    sidebarOrder: 0,
  },
  {
    ...
    group: "explore",
    kind: "page",
    href: "/docs/explorer?domain=bus&tab=browse",
    sidebarSection: "hidden",
    sidebarOrder: 0,
  },
  {
