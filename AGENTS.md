...
Client navigation (first tap, persistent chrome, React-owned DOM, native `loading.tsx`): [docs/client-navigation.md](./docs/client-navigation.md) and [`.cursor/rules/client-navigation.mdc`](./.cursor/rules/client-navigation.mdc).
