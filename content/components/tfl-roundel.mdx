...
Setting the flag shifts trademark responsibility to your application. See [TfL brand IP](https://tfl.gov.uk/info-for/business-and-advertisers/using-tfl-brand-ip). Without the flag you see the placeholder disc and bar.
