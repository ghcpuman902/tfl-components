...
A hosted Board is configured in the `/board/view` fragment, not the query string. See [iPad wall display](/docs/ipad-dashboard) for Safari and Add to Home Screen, and the [Board URL specification](/docs/board-url) for every supported parameter, including how the TfL key stays in the fragment.
