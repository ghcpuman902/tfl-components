...
On the [TfL API portal](https://api-portal.tfl.gov.uk/), subscribe to **500 Requests per min**, then copy Primary or Secondary from Profile. `app_id` has been unused since Jan 2021.
