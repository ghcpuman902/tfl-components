...
You need a React app with [shadcn](https://ui.shadcn.com/docs) already initialised. Then go back to [Introduction](/docs) for the TfL key and the board install.
...
4. Follow [Introduction](/docs). Use the Server Action tab if you want the key to stay on the server.
...
4. Follow the React tab on [Introduction](/docs). That calls TfL from the browser. Do not publish the site with the key in the client.
